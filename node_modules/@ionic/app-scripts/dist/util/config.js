...
function generateContext(context) {
    ...
    var readConfigJson = path_1.resolve(getConfigValue(context, '--readConfigJson', null, Constants.ENV_READ_CONFIG_JSON, Constants.ENV_READ_CONFIG_JSON.toLowerCase(), 'true'));
    ...
    logger_1.Logger.debug("outputJsMapFileName set to " + outputJsMapFileName);
    ...
    logger_1.Logger.debug("outputCssMapFileName set to " + outputCssMapFileName);
