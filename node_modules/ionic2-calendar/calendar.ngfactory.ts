...
class View_CalendarComponent10 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._MonthViewComponent_0_3.check_markDisabled(currVal_0_0_9,throwOnChange,false);
    const currVal_0_0_10:any = this.parentView.context.locale;
    this._MonthViewComponent_0_3.check_locale(currVal_0_0_10,throwOnChange,false);
